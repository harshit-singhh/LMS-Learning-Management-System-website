...
export const cancelSubscription = asyncHandler(async (req, res, next) => {
  ...
  try {
    ...
    user.subscription.status = subscription.status;
    console.log(`status after cancellation - ${subscription.status}`);
  ...
  // refund period which in our case is 14 day s
  ...
  // await payment.deleteOne(); // or payment.delete() in some versions
