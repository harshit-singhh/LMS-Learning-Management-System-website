...
const userSchema = new Schema(
  {
    ...
    password: {
      ...
      // this helps when we do const user = awaitUser.findOne({_id : req.user.id})
      //here the user which we'll get, uska password nhi milega humko

      // if you still want password then write
