...
function CheckoutSuccess() {
  ...
  // we did this here because... jab payment verify hui backend me to 
  // humne backend me subsctiption status = active set kiya user ka, but 
  // ab humne jo changes db me save kiye he.. wo state me bhi to lane he..
  useEffect(() => {
